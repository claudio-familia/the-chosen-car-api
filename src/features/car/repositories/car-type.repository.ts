...
import { RestRepository } from "src/shared/models/rest-repository.interface";
...
export class CarTypeRepostory extends Repository<CarType> implements RestRepository<CarType, CarTypeDto> {
